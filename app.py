...
# ==========================================
# ADVANCED CSS: ALIGNMENT & RESPONSIVENESS
# ==========================================
st.markdown("""
<style>
...
/* 1. Perfect Centering for the Image Comparison Iframe */
...
/* 2. Safe Responsiveness for the Iframe */
/* This prevents horizontal scroll on mobile while keeping the slider JS intact */
iframe {
...
/* 3. Text & Image Alignment Wrappers */
.desc-wrapper {
    display: flex;
    justify-content: center;
    width: 100%;
...
.detailed-desc {
    ...
    line-height: 1.5;
    margin-top: 10px;
    text-align: left; /* Keeps text readable while the block itself is centered */
    width: 100%;
    max-width: 600px; /* Locked to the exact width of the image sliders */
}
</style>
...
# Base width expanded to 600 to ensure full labels fit nicely
slider_width = 600
