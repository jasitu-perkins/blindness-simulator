...
# ==========================================
# ADVANCED CSS: FLEX-WRAP & PERKINS BRANDING
# ==========================================
st.markdown("""
<style>
/* 1. Page Background (Replaces the empty white space) */
[data-testid="stAppViewContainer"] {
    background-color: #E2EAF4 !important; /* Soft Perkins-inspired accessible blue */
}

/* 2. Sticky Navigation Bar with Perkins Branding */
.nav-bar {
    display: flex;
    justify-content: center;
    gap: 40px;
    background-color: #002D72; /* Perkins Navy */
    padding: 18px;
    border-bottom: 5px solid #00A3E0; /* Perkins Cyan */
...
.nav-bar a:hover {
    color: #E31837; /* Perkins Red */
}

/* 3. Global Typography Coloring */
h1, h2, h3, h4 {
...
/* 4. Magic Flex-Wrap Layout for the Simulation Grid */
/* This targets only the columns AFTER our custom marker, preserving the uploader layout */
.sim-grid-start ~ [data-testid="stHorizontalBlock"] {
    flex-wrap: wrap !important;
    justify-content: center !important;
    gap: 30px !important; /* Space between wrapped cards */
}

/* 5. Perkins Branded 'Cards' that wrap instead of shrink */
.sim-grid-start ~ [data-testid="stHorizontalBlock"] > [data-testid="column"] {
    background-color: #FFFFFF;
    border-top: 6px solid #002D72; /* Navy */
    border-bottom: 6px solid #E31837; /* Red */
    padding: 25px 20px !important;
    border-radius: 12px;
    box-shadow: 0px 8px 16px rgba(0, 45, 114, 0.08);
    
    /* The core logic: Lock the width and force wrapping */
    min-width: 600px !important;
    max-width: 600px !important;
    flex: 1 1 600px !important; 
}

/* Center the image sliders inside the cards */
...
/* Text Formatting inside the cards */
.desc-wrapper {
    display: flex;
    justify-content: center;
    width: 100%;
...
.detailed-desc {
    ...
    color: #333333;
    width: 100%;
    max-width: 550px; /* Locked to perfectly match the slider */
}
</style>
...
<p style='text-align: center; font-size: 1.2em; color: #4A5568;'>
    Inspired by <a href='https://www.perkins.org/what-blindness-really-looks-like/' target='_blank' style='color: #00A3E0; font-weight: bold;'>Perkins School for the Blind</a>.<br>
    Generated by Jacky Situ in Google Gemini AI.<br>
    📸 Photo Credit: <a href='https://www.pexels.com/@ganajp/' target='_blank' style='color: #00A3E0;'>Petr Ganaj</a>
</p>
""", unsafe_allow_html=True)
...
# Locked, safe width to fit inside the 600px cards
slider_width = 550

# MAGIC MARKER: This hidden div tells our CSS where to apply the flex-wrap card styles
st.markdown('<div class="sim-grid-start"></div>', unsafe_allow_html=True)

# By creating 6 columns in one block, our CSS will naturally wrap them into rows
